...
bool Patient:: operator==(const Patient& patient) {
	return strcmp(this->first_name, patient.first_name) == 0 && strcmp(this->last_name, patient.last_name) == 0 and this->age == patient.age and strcmp(this->reason, patient.reason)==0;
}
